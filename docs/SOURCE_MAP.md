...
| `sql/robot-management/h2/V000__baseline.sql` | H2 机器人管理版本化升级基线；当前未正式上线，空文件保留版本起点 |
| `sql/robot-management/mysql/V000__baseline.sql` | MySQL 机器人管理版本化升级基线；当前未正式上线，空文件保留版本起点 |
